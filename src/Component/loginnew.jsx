...
import {  useNavigate } from "react-router-dom";
  ...
  function Login({ onOpen, isOpen, onClose }) {
    ...
    const [loginUser,setLoginUser]=useState({
      ...
      const SignIn=()=>{
        const Users=signInWithEmailAndPassword(auth,loginUser.email,loginUser.password).then((users)=>{
                ...
                <>
                  ...
                  <VStack h="70vh">
                    ...
                    <Box w="100%">
                      ...
                      >
                        <FaMobile />
                        <Text fontWeight="bold" onClick={()=>setisEmailLogin(3)}>Continue With Phone</Text>
                      </HStack>
                      <HStack
                        // _hover={{ border: "5px solid black" }}
                        border="2px solid black"
                      ...
                      >
                        <FaGoogle />
                        <Text fontWeight="bold" onClick={SigninWithGoogle}>Continue With Google</Text>
                      </HStack>
                    </Box>
