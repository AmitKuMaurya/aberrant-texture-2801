...
export const SingleCar = () => {
 ...
 const getCarById = (id) => {
  ...
  return (
        ...
        <GridItem p="1rem" rowSpan={1} colSpan={2} style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>    {/* seller info */}
          ...
          <Flex>
           ...
           <Box p="0.5rem" align="left"> 
            <Text fontWeight="bold" fontSize="md">Genuine Cars By SAAS MOTORS</Text>
    ...
    >
 {cars.map((car) => (
          <SwiperSlide>    <Box key={car.id}  style={{boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px", minHeight: "100px",
          ...
          <Text align="left" mb="0.2rem" fontSize={["xs","xs", "sm"]} color="#9badaf">{car.year}-{car.driven} km</Text>
