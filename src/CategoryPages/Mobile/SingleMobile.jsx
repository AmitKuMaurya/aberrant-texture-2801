...
export const SingleMobile = () => {
  ...
  const getMobileById = (id) => {
    return axios(`https://project-api-ytxm.onrender.com/olxmobiles/${id}`);
  };
          ...
          <Flex>
            ...
            <Box p="0.5rem" align="left">
              <Text fontWeight="bold" fontSize="md">
                Genuine Mobiles By SAAS MOBILES
              </Text>
              ...
              <SwiperSlide>
                ...
                >
                  ...
                  <Box
                    ...
                    mt="1rem"
                    className={
                      mobile.id < 4 ? style.yellowLine : style.noYellowLine
                    }
                  >
                    <Text
                      align="left"
